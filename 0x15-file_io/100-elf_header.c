...
/**
 * print_class - Prints to the class of an ELF header.
...
/**
 * print_abi - Print to the ABI version of an ELF header.
...
/**
 * print_type - Print to the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
...
/**
 * print_entry - Print to the entry point of an ELF header.
